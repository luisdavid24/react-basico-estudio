...
export default function Estilos(){
    ...
    return(
        <section className='estilos'>
            ...
            <h3  className='bd-react'>Estilos en hojas css externa</h3>
            <h3  
            className='bd-react'
            style={{borderRadius:".25rem",margin:"1rem"}}>
            Estilos linea (atributo styles)</h3>
            <h3  className='bd-react' style={myStyles}>Estilos en linea</h3>
            ...
            <h3 className="bg-sass">Estilos con SASSS</h3>
